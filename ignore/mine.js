    ...
    render() {
        return (
            <View style={styles.audioPanel}>
                ...
                {/* <VrButton></VrButton> .THIS REFFERS TO THE THE FUNCTION ON THIS COMPONENT! OH WOW, JUST CLICKED*/}
            </View>
        )
    }
}
        ...
        return (
            <View>
                <VrButton style={this.state.hover ? styles.hover : styles.button}
                    ...
                    onClick={() => this.clickHandler(this.props.room.split(' ').join('_'))}> {/* took me an hour to troubleshoot this.. it's not in the video!*/}
...
const styles = StyleSheet.create({
    ...
    infoPanel: {
        ...
        borderWidth: 5,
        borderRadius: 20,
        // flexDirection: 'column',  //react 360 works with flexDirections, it's awesome!!! 
        // flexDirection: 'row',
